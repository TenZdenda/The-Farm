#pragma checksum "/Users/zdenekpasek/www/The-Farm-2.0/farm/Pages/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "056d4aeacbbe8ed559c449eeb9c53512b9908335"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"056d4aeacbbe8ed559c449eeb9c53512b9908335", @"/Pages/Index.cshtml")]
    ...
    public class Pages_Index : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        ...
        private static readonly global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute __tagHelperAttribute_2 = new global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute("class", new global::Microsoft.AspNetCore.Html.HtmlString("lg:inline-flex lg:w-auto w-full px-7 py-2 text-black items-center justify-center lg:bg-green-500 lg:text-white hover:bg-green-700"), global::Microsoft.AspNetCore.Razor.TagHelpers.HtmlAttributeValueStyle.DoubleQuotes);
...
<nav class=""flex items-center bg-white p-3 flex-wrap shadow-xl"">
    ...
    <div class=""hidden top-navbar w-full lg:inline-flex lg:flex-grow lg:w-auto"" id=""navigation"">
        <div class=""lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start flex flex-col lg:h-auto"">
            ...
            <a href=""#about"" class=""lg:inline-flex lg:w-auto w-full px-7 py-2 rounded text-black items-center justify-center hover:bg-gray-100"">
                <span>About us</span>
            </a>

            <a href=""#our-cows"" class=""lg:i");
            WriteLiteral(@"nline-flex lg:w-auto w-full px-7 py-2 rounded text-black items-center justify-center hover:bg-gray-100"">
                <span>Our cows</span>
            </a>

            <a href=""#contact"" class=""lg:inline-flex lg:w-auto w-full px-7 py-2 rounded text-black items-center justify-center hover:bg-gray-100"">
                <span>Contact us</span>
            </a>

            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "056d4aeacbbe8ed559c449eeb9c53512b99083358712", async() => {
...
<section class=""flex h-screen bg-cow-bg bg-cover bg-center p-4"">
    <div class=""m-auto"">
        ...
        <button class=""p-3 rounded shadow-xl bg-white w-36 block mx-auto md:mx-0 mt-10 hover:bg-gray-200 duration-150"">Our cows</button>
    </div>
</section>
<section class=""md:h-screen"" id=""about"">
    <div class=""md:flex"">
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "056d4aeacbbe8ed559c449eeb9c53512b990833510874", async() => {
            }
            );
...
<section class=""h-screen p-4"" id=""our-cows"">
    <div class=""pt-10"">
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "056d4aeacbbe8ed559c449eeb9c53512b990833514112", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
        ...
        <p class=""text-gray-600 text-justify mt-8 w-96 mx-auto block"">
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Vestibulum fermentum tortor id mi. Nunc auctor. Vivamus luctus egestas leo. Sed convallis magna eu sem. Ut tempus purus at lorem. Fusce suscipit libero eget elit. Integer rutrum, orci vestibulum ullamcorper ultricies, lacus quam ultricies odio, vitae placerat pede sem sit amet enim. Fusce dui leo, imperdiet in, aliquam sit amet, feugiat eu, orci. Cras elementum. Phasellus rhoncus. In enim a arcu imperdiet malesuada. Nunc tincidunt ante vitae massa.
        </p>
    </div>
</section>
<section class=""p-4 md:mb-10"" id=""contact"">
    ...
    <div class=""md:flex"">
        <div class=""form md:flex-1 md:order-last md:mr-20"">
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "056d4aeacbbe8ed559c449eeb9c53512b990833516272", async() => {
                WriteLiteral(@"
